...
public class EvalUtils {
   ...
   */
  public FastVector getCVPredictions(knnClassifier classifier, 
                                     Instances data, 
                                     int numFolds) 
    throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  public FastVector getTrainTestPredictions(knnClassifier classifier, 
   ...
   * @exception Exception if an error occurs
   */
  public FastVector getTestPredictions(knnClassifier classifier, 
                                       Instances test) 
    throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  public Prediction getPrediction(knnClassifier classifier,
                                  Instance test)
    throws Exception {
